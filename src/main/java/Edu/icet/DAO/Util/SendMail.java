...
public class SendMail {
    public static void outMail(String msg, String to, String subject) throws MessagingException {
        ...
        String from = "snanayakkara426@gmail.com";
        ...
        Session session = Session.getDefaultInstance(properties, new Authenticator() {
            protected javax.mail.PasswordAuthentication getPasswordAuthentication() {
                return new PasswordAuthentication("snanayakkara426@gmail.com", "srkxhlfhmtqerzdf");  // have to change some settings in SMTP
            }
        });
